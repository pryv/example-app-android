...
public class ChatActivity extends Activity {
    ...
    private void init(){
        ...
        mBluetoothController.setBluetoothListener(new BluetoothListener() {
            ...
            public void onBluetoothServiceStateChanged(final int state) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        mConnectState = state;
                        tvConnectState.setText("Connection state: " + BluetoothPrinter.transConnStateAsString(state));
                    }
                });
            }
        ...
        tvConnectState.setText("Connection state: "
                + BluetoothPrinter.transConnStateAsString(mBluetoothController.getConnectionState()));
